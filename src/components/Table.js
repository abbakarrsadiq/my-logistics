...
const Table = () => {
 const customers = [
    ...
    { id: 12, name: 'David', pickUp: 'Iyana Ipaja', dropOff: 'Surulere' }, { id: 1, name: 'Muhammad', pickUp: 'Lekki Phase I', dropOff: 'Banana Island' },
    ...
    { id: 18, name: 'Muhammad', pickUp: 'Lekki Phase I', dropOff: 'Banana Island' },
  ];
